...
public class CategoryServicesImpl implements CategoryServices {
	...
	public Category addCategory(Category category, String key)
		...
		if (cat != null) {
			throw new CategoryException(
					"Category with this category name already exist => " + category.getCategoryName());
		} else {
	...
	@Override
	public Category updateCategory(Category category, String key)
			throws CategoryException, AdminException, LoginException {
		CurrentUserSession loggedInUser = currentUserSessionRepo.findByUniqueID(key);
	...
	@Override
	public Category deleteCategory(String categoryName, String key)
			throws CategoryException, AdminException, LoginException {
		CurrentUserSession loggedInUser = currentUserSessionRepo.findByUniqueID(key);
